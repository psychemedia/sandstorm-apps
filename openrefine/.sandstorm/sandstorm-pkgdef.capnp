...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "w2p0yngnyh296nunjzgcvdk6hnyae5t5wwdhyrcvf7dd650shq2h",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "OpenRefine"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New OpenRefine Instance"),
        command = .myCommand
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/psychemedia/sandstorm-apps",
      ...
      author = (
        ...
        contactEmail = "tony.hirst@gmail.com",
        ...
        upstreamAuthor = "OpenRefine Team",
      ...
      shortDescription = (defaultText = "Data cleaner"),
  ...
  sourceMap = (
    ...
    searchPath = [
      ...
      ( sourcePath = "/",    # Then search the system root directory.
        ...
        # ##TH - remove etc/passwd for OpenRefine:  h/t Drew Fisher
        # ## via https://groups.google.com/d/msg/sandstorm-dev/48k6jvSAuPU/FjuzC-3EAwAJ
