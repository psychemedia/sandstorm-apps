...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "ne8v2vnp5sn7j2jkxx050frc2gn7ngrxckhj789r46e1meknd1z0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Tabula PDF Data Extractor"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New Tabula Instance"),
        command = .myCommand
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/psychemedia/sandstorm-apps/tabula",
      ...
      author = (
        ...
        upstreamAuthor = "tabula team - github.com/tabulapdf/tabula",
      ...
      shortDescription = (defaultText = "Extra tables from PDFs"),
